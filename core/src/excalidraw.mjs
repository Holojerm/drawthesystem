/**
 * excalidraw.mjs — build a valid .excalidraw document from a simple graph spec.
 *
 * Library form of the generator: buildExcalidraw(spec) -> document object.
 * The CLI lives in scripts/excalidraw.mjs at the repo root (a thin shim over
 * this module); this spec-format doc is kept in both places — edit both.
 *
 * Spec format (JSON):
 * {
