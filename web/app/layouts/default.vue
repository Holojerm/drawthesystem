...
const links = computed(() => [
  ...
  { label: "Sessions", icon: "i-lucide-pen-tool", to: "/sessions", active: route.path.startsWith("/sessions") },
  { label: "Companies", icon: "i-lucide-building-2", to: "/companies", active: route.path.startsWith("/companies") },
]);
</script>
