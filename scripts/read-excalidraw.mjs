...
const summary = { file: path, nodes, containers, edges, floating_text: floating,
...
if (flag === "--json") { console.log(JSON.stringify(summary, null, 2)); process.exit(0); }

const lines = [];
lines.push(`# Diagram summary: ${path}`, "");
